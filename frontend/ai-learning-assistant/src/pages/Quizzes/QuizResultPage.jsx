    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        <Link
          ...
          className="droup inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200"
        >
          <ArrowLeft
      ...
      <div className="space-y-6">
        ...
        {detailedResults.map((result, index) => {
          // Normalize helper to handle trim/case mismatches from the backend
          ...
          return (
            ...
            >
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isUserAnswer && (
                            <span
                              className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-semibold ${isCorrect ? "bg-emerald-100 border border-emerald-300 text-emerald-700" : "bg-rose-100 border border-rose-300 text-rose-700"}`}
                            >
                              {isCorrect ? (
                                <CheckCircle2
                                  className="w-3 h-3"
              ...
              {/* Explanation */}
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl mt-4">
