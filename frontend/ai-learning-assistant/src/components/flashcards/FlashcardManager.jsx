      ...
      return (
        ...
        "
          ...
          <button
            ...
            disabled={generating}
            className="group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 text-white text-sm font-semibold hover:from-emerald-600 hover:to-teal-600 rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 acive:scale-95 mt-6 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
          >
            {generating ? (
              <>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleGenerateFlashcards}
            disabled={generating}
            className="group inline-flex items-center gap-2 px-5 h-11 bg-linear-to-r from-emerald-500 to-teal-500 text-white text-sm font-semibold hover:from-emerald-600 hover:to-teal-600 rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 acive:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
          >
            {generating ? (
              <>
                <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
          ...
          {flashcardSets.map((set) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 p-2 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-lg transition-all duration-200 opacity-60 group-hover:opacity-100"
              >
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              disabled={deleting}
              className="px-5 h-11 bg-linear-to-r from-rose-500 to-rose-500 hover:from-rose-600 hover:to-rose-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
            >
              {deleting ? (
