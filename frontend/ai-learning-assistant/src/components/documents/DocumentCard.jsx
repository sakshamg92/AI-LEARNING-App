...
const DocumentCard = ({ document, onDelete }) => {
  ...
  return (
    <div
      className="group relative bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:shadow-slate-200/60 hover:border-slate-300 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1"
